    ...
    <div className="grid gap-4 lg:grid-cols-5">
      <div className="lg:col-span-3 apple-card p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/accounting/statements" className="btn-ghost">P&L <ArrowUpRight size={11} /></Link>
        </div>
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <div className="apple-card overflow-hidden">
        <div className="px-5 py-3.5 border-b border-[var(--border)] flex items-center justify-between">
          ...
          <Link href="/accounting/journals" className="btn-ghost">Ledger <ArrowUpRight size={11} /></Link>
        </div>
